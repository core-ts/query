...
function insertBatch(exec, objs, table, attrs, buildParam, notSkipInvalid, i) {
  var stm = buildToInsertBatch(objs, table, attrs, buildParam, notSkipInvalid, '', i);
  if (!stm) {
    return Promise.resolve(0);
  }
  else {
...
function buildToInsertBatch(objs, table, attrs, buildParam, notSkipInvalid, ver, i) {
  if (!i) {
    i = 1;
  }
  var ks = Object.keys(attrs);
