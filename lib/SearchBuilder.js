...
var SearchBuilder = (function () {
  ...
  SearchBuilder.prototype.search = function (s, limit, skip, fields) {
    ...
    var q2 = query_1.buildQuery(s1, x, this.table, this.attributes, sn, fields, this.q, this.excluding, this.buildSort);
    if (this.fromDB) {
      return search_1.buildFromQuery(this.query, q2.query, q2.args, limit, skip, this.map, this.bools, this.provider, this.total).then(function (r) {
      ...
      return search_1.buildFromQuery(this.query, q2.query, q2.args, limit, skip, this.map, this.bools, this.provider, this.total);
    }
  };
